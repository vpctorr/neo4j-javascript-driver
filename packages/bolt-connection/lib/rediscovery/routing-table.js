 ...
 */
import { newError, error, Integer, int, internal, json } from 'neo4j-driver-core';
const { constants: { ACCESS_MODE_WRITE: WRITE, ACCESS_MODE_READ: READ }, serverAddress: { ServerAddress } } = internal;
 ...
 * @param {RoutingTable} The valid Routing Table
 */
export function createValidRoutingTable(database, routerAddress, rawRoutingTable) {
