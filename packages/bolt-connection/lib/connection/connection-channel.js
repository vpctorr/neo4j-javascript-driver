 ...
 */
export function createChannelConnection(address, config, errorHandler, log, serversideRouting = null, createChannel = channelConfig => new Channel(channelConfig)) {
...
export default class ChannelConnection extends Connection {
    ...
    _handleFatalError(error) {
        ...
        if (this._log.isErrorEnabled()) {
            this._log.error(`experienced a fatal error caused by ${this._error} (${json.stringify(this._error)})`);
        }
