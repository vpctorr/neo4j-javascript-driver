...
import { createChannelConnection, DelegateConnection, ConnectionErrorHandler } from '../connection';
import { internal, error } from 'neo4j-driver-core';
const { constants: { BOLT_PROTOCOL_V3, BOLT_PROTOCOL_V4_0, BOLT_PROTOCOL_V4_4, BOLT_PROTOCOL_V5_1 } } = internal;
