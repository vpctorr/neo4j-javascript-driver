 ...
 */
import { assertDatabaseIsEmpty, assertTxConfigIsEmpty, assertImpersonatedUserIsEmpty, assertNotificationFilterIsEmpty } from './bolt-protocol-util';
...
import { CompletedObserver, LoginObserver, LogoffObserver, ResetObserver, ResultStreamObserver, 
// eslint-disable-next-line no-unused-vars
StreamObserver } from './stream-observers';
import { internal, newError } from 'neo4j-driver-core';
import transformersFactories from './bolt-protocol-v1.transformer';
import Transformer from './transformer';
const { bookmarks: { Bookmarks }, constants: { ACCESS_MODE_WRITE, BOLT_PROTOCOL_V1 }, 
// eslint-disable-next-line no-unused-vars
logger: { Logger }, txConfig: { TxConfig } } = internal;
