...
import { StreamObserver, LoginObserver, ResultStreamObserver, ProcedureRouteObserver } from './stream-observers';
import transformersFactories from './bolt-protocol-v3.transformer';
import Transformer from './transformer';
import { internal } from 'neo4j-driver-core';
const { 
// eslint-disable-next-line no-unused-vars
bookmarks: { Bookmarks }, constants: { BOLT_PROTOCOL_V3 }, txConfig: { TxConfig } } = internal;
...
export default class BoltProtocol extends BoltProtocolV2 {
    ...
    requestRoutingInformation({ routingContext = {}, sessionContext = {}, onError, onCompleted }) {
        const resultObserver = this.run(CALL_GET_ROUTING_TABLE, { [CONTEXT]: routingContext }, { ...sessionContext, txConfig: TxConfig.empty() });
