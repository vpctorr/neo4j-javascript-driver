...
const { util: { assertString } } = internal;
...
const VERSION_IN_DEV = new ServerVersion(maxVer, maxVer, maxVer, NEO4J_IN_DEV_VERSION_STRING);
export { ServerVersion, VERSION_3_2_0, VERSION_3_4_0, VERSION_3_5_0, VERSION_4_0_0, VERSION_IN_DEV };